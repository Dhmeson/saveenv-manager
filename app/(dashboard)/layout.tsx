...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  return (
      <ProjectsProvider>
        <div className="relative flex h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-900">
          ...
          <Sidebar />
          <div className="relative z-10 flex-1 flex flex-col lg:ml-0">
            <Header />
